...
if __name__ == '__main__':
    ...
    deltas = [0.05]
    for constraint_name in ["demographic_parity","predictive_equality"]: #"disparate_impact","demographic_parity","equalized_odds","equal_opportunity",
        save_dir = os.path.join(save_base_dir,f'vfae_{constraint_name}')
        ...
        if constraint_name == 'demographic_parity':
            constraint_strs = ['ACC >= 0.6'] #'abs((PR | [M]) - (PR | [F])) <= 0.2'
